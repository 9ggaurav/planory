...
const getTaskListById = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, tasklist, "retrieving tasklist by id"));
});
const editTaskList = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, updatedTaskList, "taskList has been updated successfully!"));
});
const moveTaskList = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, updatedTaskList, "Task list moved successfully."));
});
const deleteTasklistById = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, deletedTasklist, "Tasklist deleted successfully!"));
});
// task controllers
const createTask = asyncHandler(async (req, res) => {
    ...
    return res
        .status(201)
        .json(new ApiResponse(201, createdTask, "task has been created successfully!"));
});
...
export { getTaskListById, editTaskList, moveTaskList, createTask, deleteTasklistById, getAllTasks };
