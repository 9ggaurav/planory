  ...
  export default function WorkspaceCard({
    ...
    return (
      <Link draggable={true} href={`/b/${id}`}>
        <Card className="w-60 h-38 overflow-hidden shadow-md rounded-2xl border-[#D0ECE4] hover:border-[#B8E0D6] hover:bg-[#F5FBF8] hover:scale-102">
        ...
        <div className="relative h-28 w-full">
...

          {
            isTemplate &&
              <Badge
              variant="secondary"
              className="absolute bottom-1 right-1 z-10 text-xs px-2 py-0.5 bg-[rgba(255,255,255,0.8)] text-[#2D5C4F]"
            >
              <p>Template</p>
            </Badge>
          }
